...
# 支持通过环境变量配置配置目录（用于Android等嵌入式环境）
CONFIG_DIR = os.environ.get('MAIBOT_CONFIG_DIR', os.path.join(PROJECT_ROOT, "config"))
TEMPLATE_DIR = os.environ.get('MAIBOT_TEMPLATE_DIR', os.path.join(PROJECT_ROOT, "template"))
